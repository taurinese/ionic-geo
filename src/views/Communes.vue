  ...
  <ion-page>
    <ion-content :fullscreen="true">
      <ion-header collapse="condense">
        <ion-toolbar>
          <ion-title size="large" class="ion-text-center">Communes</ion-title>
        </ion-toolbar>
      </ion-header>
      <Search id="container" @fetch="sendToDisplay" :message="'Veuillez entrer un code postal ou une commune..'" :tabName="'commune'" v-if="!result"></Search>
