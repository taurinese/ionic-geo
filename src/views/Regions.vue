  ...
  <ion-page>
    <ion-content :fullscreen="true">
      <ion-header collapse="condense">
        <ion-toolbar>
          <ion-title size="large" class="ion-text-center">Régions</ion-title>
        </ion-toolbar>
      </ion-header>
      <Search id="container" @fetch="sendToDisplay" :message="'Veuillez sélectionner une région..'" :tabName="'region'"  v-if="!result"></Search>
